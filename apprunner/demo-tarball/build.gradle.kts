...
plugins {
  `java-library`
  `jvm-test-suite`
  id("org.apache.polaris.apprunner") version "0.1-SNAPSHOT"
}
...
val demoTest =
  tasks.named("demoTest") {
    ...
    // We want to rerun the tests for the sake of the demo. DO NOT COPY THIS ONE!
    outputs.upToDateWhen { false }
  }

tasks.named("check") { dependsOn(demoTest) }
